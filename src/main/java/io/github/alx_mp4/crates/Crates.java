package io.github.alx_mp4.crates;

import com.sk89q.worldguard.bukkit.WorldGuardPlugin;
import io.github.alx_mp4.crates.block.CustomLockedChest;
import io.github.alx_mp4.crates.command.CratesCommand;
import io.github.alx_mp4.crates.listener.block.BlockBreakListener;
import io.github.alx_mp4.crates.listener.block.BlockPistonListener;
import io.github.alx_mp4.crates.listener.block.BlockPlaceListener;
import io.github.alx_mp4.crates.listener.entity.EntityExplodeListener;
import io.github.alx_mp4.crates.listener.player.PlayerInteractListener;
import io.github.alx_mp4.crates.sqlite.SqliteDatabase;
import io.github.alx_mp4.crates.util.config.ConfigUtil;
import io.github.alx_mp4.crates.util.log.UpdateUtil;
...
public class Crates extends JavaPlugin {
    ...
    public void onEnable() {
        UpdateUtil.checkAvailablePluginUpdates(this, "https://api.github.com/repos/alx-mp4/Crates/releases/latest");
    ...
    public void onDisable() {
        ...
        try {
            ...
            LogUtil.logConsoleSevere(String.format("[%s] An exception occurred whe closing SQLite database connection: %s", getDescription().getName(), e));
        }
